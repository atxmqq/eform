...
<div class="wrapper">
    ...
    <div class="body">
        <p>
            เรียน <?php echo e($advisor->prefixname); ?><?php echo e($advisor->advisorname); ?> <?php echo e($advisor->advisorsurname); ?>,
        </p>
        <p>
            นิสิตได้ยื่น<strong><?php echo e($submission->formType->name); ?></strong>
        ...
        <div class="info-card">
            <table>
                <tr>
                    <td>ประเภทคำร้อง</td>
                    <td><?php echo e($submission->formType->name); ?></td>
                </tr>
                <tr>
                    <td>ชื่อนิสิต</td>
                    <td>
                ...
                <tr>
                    <td>รหัสนิสิต</td>
                    <td><?php echo e($student->std_id_std ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>สาขาวิชา</td>
                    <td><?php echo e($student->std_major_th ?? $student->std_major_en ?? '-'); ?></td>
                </tr>
                <tr>
                    <td>วันที่ยื่น</td>
        ...
        <a href="<?php echo e(config('app.url')); ?>/approver" class="btn">เข้าสู่ระบบพิจารณาคำร้อง</a>
    </div>
    <div class="footer">
        อีเมลนี้ส่งโดยอัตโนมัติจากระบบ <?php echo e(config('app.name')); ?> — กรุณาอย่าตอบกลับอีเมลนี้
    </div>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\xampp\e-form\resources\views/mail/advisor-submission.blade.php ENDPATH**/ ?>