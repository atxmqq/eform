<x-layout title="{{ __('ui.submission.submit_title_prefix') }}: {{ $formType->name }}">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 max-w-2xl">
        ...
        <form action="{{ route('student.submissions.store', $formType) }}" method="POST" enctype="multipart/form-data" class="space-y-5" id="submission-form">
            ...
            {{-- Reinstatement (คำร้องคืนสภาพ) --}}
            @if($formType->code === 'reinstatement')
            <div class="space-y-6">

                {{-- ส่วนที่ 1: เหตุผลที่พ้นสภาพ --}}
                <div class="space-y-3">
                    <div>
                    ...
                    <div class="border border-gray-200 rounded-xl p-5 bg-white space-y-5">
                            ...
                            <div class="flex-1 text-sm text-gray-800">
                                <div class="leading-loose">
                                    ...
                                    <input type="number" name="missed_semesters_count" min="1"
                                        value="{{ old('missed_semesters_count') }}"
                                    ...
                                    <input type="text" name="missed_semester_details"
                                        value="{{ old('missed_semester_details') }}"
                        ...
                        {{-- กรณีที่ 2: ไม่ได้ลงทะเบียน --}}
                        <label class="flex items-start gap-3 cursor-pointer group">
                            <input type="radio" name="loss_reason_type" value="not_enrolled"
                                {{ old('loss_reason_type') === 'not_enrolled' ? 'checked' : '' }}
                    ...
                    @error('loss_reason_type')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>

                {{-- ส่วนที่ 2: ความประสงค์ขอคืนสภาพ และ ลาพัก --}}
                <div class="border border-gray-200 rounded-xl p-5 bg-white space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-4 ml-6 text-sm text-gray-800">
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="retain_status_semester" value="1" required {{ old('retain_status_semester') == '1' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคต้น/ 1<sup>st</sup> semester</span>
                            </label>
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="retain_status_semester" value="2" {{ old('retain_status_semester') == '2' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคปลาย/ 2<sup>nd</sup> semester</span>
                            </label>
                            <div class="flex items-center gap-2 ml-4">
                                <span>ปีการศึกษา/ Academic Year</span>
                                <input type="text" name="retain_status_year" required value="{{ old('retain_status_year') }}" class="w-24 h-8 px-2 py-1 text-center border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" placeholder="เช่น 2566">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-4 ml-6 mb-4 text-sm text-gray-800">
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="leave_from_semester" value="1" {{ old('leave_from_semester') == '1' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคต้น/ 1<sup>st</sup> semester</span>
                            </label>
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="leave_from_semester" value="2" {{ old('leave_from_semester') == '2' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคปลาย/ 2<sup>nd</sup> semester</span>
                            </label>
                            <div class="flex items-center gap-2 ml-4">
                                <span>ปีการศึกษา/ Academic Year</span>
                                <input type="text" name="leave_from_year" value="{{ old('leave_from_year') }}" class="w-24 h-8 px-2 py-1 text-center border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" placeholder="เช่น 2566">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center gap-4 ml-6 text-sm text-gray-800">
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="leave_to_semester" value="1" {{ old('leave_to_semester') == '1' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคต้น/ 1<sup>st</sup> semester</span>
                            </label>
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="leave_to_semester" value="2" {{ old('leave_to_semester') == '2' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer">
                                <span>ภาคปลาย/ 2<sup>nd</sup> semester</span>
                            </label>
                            <div class="flex items-center gap-2 ml-4">
                                <span>ปีการศึกษา/ Academic Year</span>
                                <input type="text" name="leave_to_year" value="{{ old('leave_to_year') }}" class="w-24 h-8 px-2 py-1 text-center border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" placeholder="เช่น 2566">
                            </div>
                        </div>
                    </div>
